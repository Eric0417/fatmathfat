import { CheckCircle2, CircleAlert, ClipboardList, RotateCcw, Timer } from 'lucide-react';
import { useState } from 'react';
import { QuestionRunner } from '../components/QuestionRunner';
import { quizQuestions } from '../data/questions';
import { addQuizResult } from '../lib/storage';
import type { MistakeTag, QuizResultRecord, QuizTopic } from '../types';
...
function QuizSummary({ result }: { result: QuizResultRecord }) {
  return (
    <div className="panel quiz-summary">
      <div className="quiz-summary__headline">
        ...
        <div>
          <span className="panel-kicker">測驗結果</span>
...
export function QuizPage() {
  ...
  return (
    <div className="page-stack">
      <div className="page-heading">
        <div>
          <span className="eyebrow">12 題 ・ 6 個概念</span>
          <h1>綜合測驗</h1>
      ...
      <div className="panel quiz-intro">
        ...
        <div>
          <h2>準備好就開始</h2>
          <p>題目涵蓋：集合與元素、子集合、交集、聯集、差集與補集。</p>
